...
bot.on('message', function (user, userID, channelID, message, evt) {
	...
	var hArray = ["A young girl looks in her bedroom mirror to apply her lipstick. Nothing is reflected back at her, just darkness.", "You have exclusive use of a private jet and unlimited means. Where do you go? What if you can't come back?", 
			...
			"Late one night you hear a knock at the door. You open it to see Death himself waiting. He offers you a bargainÖ", "What if you fabricated a past only to start suffering the emotional and physical trauma associated with that life?",
			...
			"As we walked through the wood the trees leaned inwards, and my hands became sticky not with sapÖ but with blood.", "Your bare feet pounds the forest floor as you realise you are not the hunted, you are the hunter.",
...
var rArray = ["She took the same seat she always does. This time, there was someone with her.", "I knew it was over the day he shouted for mushrooms.", "Two days after the proposal, she found a card at her doorstep, written in messy handwriting: 'DON'T MARRY HIM.'",
		...
		"Your estranged sister unexpectedly dies and would like you to become guardian to her son.", "'I love you',ù she said, but it came out like a scream. Mucus glistened from her nose and mouth. 'You're crazy.'", 
